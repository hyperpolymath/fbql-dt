...
// Bidirectional FFI: Lean 4 ↔ Zig ↔ FormDB Forth core
...
export fn fdb_insert(
    ...
    // 3. Insert into FormDB via Forth FFI
    // 4. Return status

    return FdbStatus.ok.toC();
}

/// Reverse: FormDB → Zig → Lean 4
...
export fn fdb_register_constraint_checker(
    ...
    // When FormDB validates data, call this Lean 4 checker
...
export fn fdb_get_discovered_fds(
    ...
    // 1. Query FormDB for collection statistics
