...
# Rebrand FormDB/FBQL to Lithoglyph/GQL throughout gql-dt project
...
echo "3. Rename WP06 file: mv docs/WP06_Dependently_Typed_FormDB.md docs/WP06_Dependently_Typed_Lithoglyph.md"
echo "4. Update code comments in .lean files (manual)"
echo "5. Verify build: lake build"
echo "6. Commit: git add -A && git commit -m 'Rebrand FormDB/FBQL to Lithoglyph/GQL'"
