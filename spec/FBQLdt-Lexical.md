...
FBQLdt source files are encoded in **UTF-8**.
...
FBQLdt source text is a sequence of **tokens** separated by **whitespace** and **comments**.
...
formdb_bounds, formdb_prov, formdb_prompt
...
FBQLdt supports **Unicode identifiers** following Unicode Standard Annex #31:
...
FBQLdt treats the following as **whitespace**:
...
FBQLdt accepts Unicode mathematical symbols with ASCII alternatives:
...
FBQLdt follows SQL conventions:
...
**Document Status:** Complete lexical specification for FBQLdt v1.0
