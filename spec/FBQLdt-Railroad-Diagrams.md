...
This document provides railroad diagram specifications for FBQLdt syntax. These can be used with:
...
WITH_PROOF ─ {
  ...
  overall_correct: by formdb_prompt
} ─
...
# Generate diagrams
rr < FBQLdt-Grammar.ebnf > diagrams.html
```
...
3. **FBQLdt Grammar:** `FBQLdt-Grammar.ebnf`
4. **W3C EBNF Notation:** https://www.w3.org/TR/REC-xml/#sec-notation

---

**Document Status:** Complete railroad diagram specifications for FBQLdt v1.0
